 ...
 * @since  1.6
 */
class Ra_walkseditorModelEvent extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	public function getItem($id = null)
	{
		...
		{
			$this->_item->status = JText::_('COM_RA_WALKSEDITOR_EVENTS_STATUS_OPTION_' . $this->_item->status);
		}
