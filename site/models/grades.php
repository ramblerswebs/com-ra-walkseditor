 ...
 * @since  1.6
 */
class Ra_walkseditorModelGrades extends \Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
            ...
            $query->from('`#__ra_walkseditor_grades` AS a');
		...
		else
		{
            ...
            if (!empty($search))
            {
                ...
                else
                {
					...
					$query->where('( a.localgrade LIKE ' . $search . ' )');
                }
            }
