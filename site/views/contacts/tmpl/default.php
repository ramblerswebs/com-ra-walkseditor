...
$canCreate  = $user->authorise('core.create', 'com_ra_walkseditor') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'contactform.xml');
$canEdit    = $user->authorise('core.edit', 'com_ra_walkseditor') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'contactform.xml');
...
<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post"
	...
	<?php echo JHtml::_('grid.sort', 'JPUBLISHED', 'a.state', $listDirn, $listOrder); ?>
			...
			<?php endif; ?>
							...
							<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_RA_WALKSEDITOR_CONTACTS_ID', 'a.id', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_RA_WALKSEDITOR_CONTACTS_CONTACTNAME', 'a.contactname', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_RA_WALKSEDITOR_CONTACTS_DISPLAYNAME', 'a.displayname', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_RA_WALKSEDITOR_CONTACTS_EMAIL', 'a.email', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_RA_WALKSEDITOR_CONTACTS_TELEPHONE1', 'a.telephone1', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_RA_WALKSEDITOR_CONTACTS_TELEPHONE2', 'a.telephone2', $listDirn, $listOrder); ?>
				</th>


							<?php if ($canEdit || $canDelete): ?>
					<th class="center">
				<?php echo JText::_('COM_RA_WALKSEDITOR_CONTACTS_ACTIONS'); ?>
				</th>
				<?php endif; ?>
		...
		<?php foreach ($this->items as $i => $item) : ?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php if (isset($this->items[0]->state)) : ?>
					...
					<td class="center">
	<a class="btn btn-micro <?php echo $class; ?>" href="<?php echo ($canChange) ? JRoute::_('index.php?option=com_ra_walkseditor&task=contact.publish&id=' . $item->id . '&state=' . (($item->state + 1) % 2), false, 2) : '#'; ?>">
	<?php if ($item->state == 1): ?>
	...
	<?php if ($canCreate) : ?>
		<a href="<?php echo Route::_('index.php?option=com_ra_walkseditor&task=contactform.edit&id=0', false, 0); ?>"
