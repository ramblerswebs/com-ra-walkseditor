...
<div class="item_fields">
	...
	<table class="table">
		...
		<tr>
			<th><?php echo JText::_('COM_RA_WALKSEDITOR_FORM_LBL_EVENT_DATE'); ?></th>
			<td><?php echo $this->item->date; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_RA_WALKSEDITOR_FORM_LBL_EVENT_CATEGORY'); ?></th>
			<td><?php echo $this->item->category; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_RA_WALKSEDITOR_FORM_LBL_EVENT_CONTENT'); ?></th>
			<td><?php echo $this->item->content; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_RA_WALKSEDITOR_FORM_LBL_EVENT_STATUS'); ?></th>
...
<?php if($canEdit && $this->item->checked_out == 0): ?>
	...
	<a class="btn" href="<?php echo JRoute::_('index.php?option=com_ra_walkseditor&task=event.edit&id='.$this->item->id); ?>"><?php echo JText::_("COM_RA_WALKSEDITOR_EDIT_ITEM"); ?></a>

<?php endif; ?>

<?php if (JFactory::getUser()->authorise('core.delete','com_ra_walkseditor.event.'.$this->item->id)) : ?>
	...
	<div id="deleteModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
		...
		<div class="modal-footer">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_ra_walkseditor&task=event.remove&id=' . $this->item->id, false, 2); ?>" class="btn btn-danger">
				<?php echo JText::_('COM_RA_WALKSEDITOR_DELETE_ITEM'); ?>
			</a>
		</div>
	</div>
