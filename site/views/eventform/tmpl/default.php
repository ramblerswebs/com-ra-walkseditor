...
<div class="event-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-event"
			  action="<?php echo Route::_('index.php?option=com_ra_walkseditor&task=event.save'); ?>"
        ...
        <?php if (true === false) { // remove this section CEV ?>
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-event").appendChild(input);
                    });
                </script>
             <?php endif; ?>
                  <?php } ?>
			<div class="control-group">
				<div class="controls ra-move-controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo Route::_('index.php?option=com_ra_walkseditor&task=eventform.cancel'); ?>"
