...
function walkeditor(data) {
    ...
    this.addEditForm = function (editDiv) {
        ...
        var publicityDiv = document.createElement('div');
        publicityDiv.setAttribute('class', 'section publicity');
        form.appendChild(publicityDiv);

        input.addHeader(publicityDiv, "h2", "Publicity");
...
//        this._restrictions = input.addSelect(itemDiv, 'moptions', 'Restrictions (viewable by) ', options, basics, 'restriction');
    ...
    this.addMeetingType = function (tag) {
        ...
        var options = {
            ...
            car: "We meet up and car share to start of walk",
    ...
    this.addWalk = function (tag) {
        ...
        this._localgrade = input.addLocalGradeSelect(tag, 'localgrade', "Local Grade:", walks[no], 'localgrade');
    ...
    this.addPublicity = function (tag) {
        ...
        if (!data.walk.hasOwnProperty('publicity')) {
            data.walk.publicity = {};
        }
        var publicity = data.walk.publicity;
        var input = new raInputFields;
        var itemDiv = input.itemsItemDivs(tag);

        input.addSelect(itemDiv, 'moptions', 'Restrictions (viewable by) ', options, publicity, 'restriction');
