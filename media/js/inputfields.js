...
function raInputFields() {
    ...
    this.addMultiChoice = function (tag, divClass, label, options, raobject, property) {
        var itemDiv = document.createElement('div');
        itemDiv.setAttribute('class', divClass);
        tag.appendChild(itemDiv);
        var _label = document.createElement('label');
...
//        itemDiv.appendChild(inputTag);
    ...
    this.addLocalGradeSelect = function (tag, divName, labelName, raobject, property) {
        var div = document.createElement('div');
        div.setAttribute('class', divName);
        tag.appendChild(div);
        var label = document.createElement('label');
        ...
        var url = ramblersMap.base + "index.php?option=com_ra_walkseditor&task=grades.controller&format=json";
        var option = document.createElement("option");
        option.value = "";
    ...
    this.addLocation = function (tag, raobject, location = '') {
        ...
        if (location !== 'area') {
            ...
            this.addComment(itemDiv, 'location', '', '* You must provide the location with a name');
