 ...
 * @since  1.6
 */
class Ra_walkseditorTablewalk extends \Joomla\CMS\Table\Table
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getUser()->authorise('core.admin', 'com_ra_walkseditor.walk.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_ra_walkseditor/access.xml',
				"/access/section[@name='walk']/"
			);
			$default_actions = Access::getAssetRules('com_ra_walkseditor.walk.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_ra_walkseditor.walk.' . (int) $this->$k;
	}
