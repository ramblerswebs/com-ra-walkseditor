 ...
 * @since  1.6
 */
class Ra_walkseditorTableevent extends \Joomla\CMS\Table\Table
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Ra_walkseditorTableevent', array('typeAlias' => 'com_ra_walkseditor.event'));
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getUser()->authorise('core.admin', 'com_ra_walkseditor.event.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_ra_walkseditor/access.xml',
				"/access/section[@name='event']/"
			);
			$default_actions = Access::getAssetRules('com_ra_walkseditor.event.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_ra_walkseditor.event.' . (int) $this->$k;
	}
