 ...
 * @since  1.6
 */
class Ra_walkseditorViewExports extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Ra_walkseditorHelper::addSubmenu('exports');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_RA_WALKSEDITOR_TITLE_EXPORTS'), 'exports.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_ra_walkseditor&view=exports');
	}
