...
<form
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'DraftWalksandEvents')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'DraftWalksandEvents', JText::_('COM_RA_WALKSEDITOR_TAB_DRAFTWALKSANDEVENTS', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_RA_WALKSEDITOR_FIELDSET_DRAFTDEATAILSOFWALKOREVENT'); ?></legend>
