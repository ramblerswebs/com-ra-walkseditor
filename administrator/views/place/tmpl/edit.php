...
<form
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'place')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'place', JText::_('COM_RA_WALKSEDITOR_TAB_PLACE', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_RA_WALKSEDITOR_FIELDSET_PLACE'); ?></legend>
