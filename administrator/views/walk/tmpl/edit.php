...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'walk.cancel') {
			Joomla.submitform(task, document.getElementById('walk-form'));
		}
		else {
			
			if (task != 'walk.cancel' && document.formvalidator.isValid(document.id('walk-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="walk-form" class="form-validate form-horizontal">
