 ...
 * @since  1.6
 */
class Ra_walkseditorViewContacts extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Ra_walkseditorHelper::addSubmenu('contacts');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_RA_WALKSEDITOR_TITLE_CONTACTS'), 'contacts.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_ra_walkseditor&view=contacts');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`contactname`' => JText::_('COM_RA_WALKSEDITOR_CONTACTS_CONTACTNAME'),
			'a.`displayname`' => JText::_('COM_RA_WALKSEDITOR_CONTACTS_DISPLAYNAME'),
			'a.`email`' => JText::_('COM_RA_WALKSEDITOR_CONTACTS_EMAIL'),
			'a.`telephone1`' => JText::_('COM_RA_WALKSEDITOR_CONTACTS_TELEPHONE1'),
			'a.`telephone2`' => JText::_('COM_RA_WALKSEDITOR_CONTACTS_TELEPHONE2'),
		);
	}
