 ...
 * @since  1.6
 */
class Ra_walkseditorViewContact extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_RA_WALKSEDITOR_TITLE_CONTACT'), 'contact.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_ra_walkseditor.contact', $this->item->id);
		}
